...
autocomplete = new google.maps.places.Autocomplete(
    document.getElementById('id_address'),
    {
        ...
        componentRestrictions: {'country': ['mx']}, // buscará en mexico
    })
...
function onPlaceChanged (){
    ...
    // loop through the address componets and assign other address data
...
$(document).ready(function(){
    ...
    // Colocando los items para que carge al incrementar con el clic
    ...
    $('.add_hour').on('click', function(e){
        e.preventDefault();
        var day = document.getElementById('id_day').value // getElementById es del formulario, en el csrf token es el name
        ...
        // Se agrega la condición porque puede estar cerrado el restaurante y se puede agregar con solo el boton de cerrado
        if(is_closed){
            is_closed = 'True'
            condiction = "day != ''"
        }else{
            is_closed = 'False'
            condiction = "day != '' && from_hour != '' && to_hour != ''"
        }
        ...
        if(eval(condiction)){
            ...
            $.ajax({
                ...
                if(response.status == 'success'){
                    // Closed es de vendor.views.add_oppening_hours en try if if
